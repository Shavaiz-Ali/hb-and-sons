      ...
      <ul className='flex justify-between items-center w-100'>
        {NavbarData.map((item, index) => (
          <Link
            to={item.link}
            key={item.id}
            className={`flex flex-column justify-center items-center sm:text-[16px] text-[14px] sm:font-[500] font-[400] text-[#000000] w-100 h-[60px] border ${activeTab === item.name ? "bg-gray-300/[0.15] text-[#D10400]" : "bg-white text-[#000000]"}`} onClick={() => setActiveTab(item.name)}
          >
